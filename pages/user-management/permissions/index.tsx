...
import ModalViewPermission from "../../../components/user-management/permissions/ModalViewPermission";
...
const Index = () => {
      ...
      cellRendererFramework: (params: any) => (
        <div>
          <Space>
            ...
            <Link href={`/user-management/permissions/edit/${params.data.id}`}>
  ...
  const onDelete = async (id: number) => {
    if (window.confirm("Are you sure?")) {
      await permissionService.delete(id).then(async (data) => {
        onGridReady(data);
      });
    }
  };
  ...
  const onUpdateStateActive = async (id: number) => {
    await permissionService.active(id, null).then(async (data) => {
      onGridReady(data);
    });
  };
        ...
        <Row>
          ...
          >
            <div style={{ marginBottom: 10 }}>
              <Space>
                <Link href="/user-management/permissions/add">
