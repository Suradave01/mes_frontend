...
import ModalFinishPrinting from "../../components/planning-management/ModalWorkFinish";
...
import AgGridReactPrintting from "../../components/planning-management/AgGridReactPrintting";
...
const Printting = () => {
  ...
  const onGridReady = useCallback((params) => {
    ...
    fetch(`${baseUrl}/findAllWorkOrderByWip/4`)
      .then((resp) => resp.json())
      .then((data) => {
        // console.log(data);
  ...
  useEffect(() => {
    (async () => {
      const data = await wipService.getById(8);
      setTabName(data);
      // console.log(data);
    })();
  }, []);
